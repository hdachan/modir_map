...
class _MY_pageState extends State<MY_page> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    // 페이지가 로드될 때 데이터 불러오기
    Future.microtask(() => context.read<UserInfoProvider>().fetchUserInfo());
  }
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => MY_page_edit()),
                        );
                      },
                      child: Container(
                        width: 360.w,
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                decoration: ShapeDecoration(
                                                  shape: RoundedRectangleBorder(
                                                    side: BorderSide(width: 1.w, color: Color(0xFF05FFF7)),
                                                    borderRadius: BorderRadius.circular(100),
                                                  ),
                                                ),
                                                child: Center(
